...
class AgentGRPO(AgentBase):
    ...
    def update_objectives(self, clean_buffer: Tuple[TEN, ...], update_t: int) -> Tuple[float, float]:
        ...
        mb_old_logprobs, mb_advantages, mb_weights = old_logprobs[indices], advantages[indices], weights[indices]
